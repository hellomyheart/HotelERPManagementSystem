<template>
  <div>
    ...
    >
      ...
      <el-table-column label="食材名" sortable prop="foodName" />
      <el-table-column label="单价价格" prop="foodPrice" />
      <el-table-column label="采购数目" sortable prop="foodCount" />
...
<script>
import { info, deleteD } from '@/api/restaurantProcurement/procurement'
export default {
  data() {
    return {
      tableData: '',
