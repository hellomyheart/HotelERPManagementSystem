<template>
  <div>
    ...
    >
      ...
      <el-table-column label="创建时间" sortable prop="creatTime" />
      <el-table-column label="职工ID" sortable prop="employeeId" />
      <el-table-column label="绩效打分" sortable prop="score" />
...
<script>
import { info, deleteD } from '@/api/performance/index'
export default {
  data() {
    return {
      tableData: '',
