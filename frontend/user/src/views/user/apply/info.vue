<template>
  <div>
    ...
    >
      ...
      <el-table-column label="申请人" prop="employeeName"/>
      <el-table-column label="资金" sortable prop="price"/>
      <el-table-column label="说明" sortable prop="note"/>
      <el-table-column label="创建时间" sortable prop="createTime"/>
      <el-table-column label="状态" sortable :formatter="formatS" prop="status"/>
...
<script>
import { info, deleteD } from '@/api/budget/apply'
export default {
  data() {
    return {
      tableData: "",
