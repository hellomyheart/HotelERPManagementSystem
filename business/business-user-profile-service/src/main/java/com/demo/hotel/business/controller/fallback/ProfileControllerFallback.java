...
public class ProfileControllerFallback {
     ...
     * @return {@link ResponseResult< UserDTO >}
     */
    public static ResponseResult<UserDTO> infoFallback(String username, Throwable ex) {
        logger.warn("Invoke infoFallback: " + ex.getClass().getTypeName());
        ex.printStackTrace();
        return new CommonsFallback<UserDTO>().returnResponseResult(CodeStatus.BREAKING, FallbackMessage.BREAKING_MESSAGE, null);
    }
